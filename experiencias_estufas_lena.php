...
?>
		...
		<div class="clear"></div>
          		<div class="colLeft">
                    <h1 class="tGrisBlueN">Estufas a leña.</h1>
                    <p>Nueva generación de Salamandras</p>
...
?>
                <div class="clear"></div>
                    ...
                    <p class="pNarBullet jus">Algunos modelos tienen calentadores de agua opcionales como segunda alternativa a otros sistemas de calefacción. Existen también modelos que incluyen hornos.</p>
                    <p class="pBlueBullet jus">Puede llevarse la estufa a leña cuando cambia de casa.</p>
                </div>  
                    <div class="clear"></div>
                </div>
