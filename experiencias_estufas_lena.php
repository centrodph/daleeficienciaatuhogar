...
<?php include("inc.submenuExperiencias2.php"); ?>
                    ...
                    <p class="jus">Hoje existe uma nova geração de lareiras, onde você pode aquecer sua casa sem fumaça, sem cheiro e sem faíscas devido às portas que utilizam vitrocerâmico. Essas lareiras têm se tornado muito populares em nosso país, por diferentes razões:  </p>
                    <p class="pNarBullet jus">Há uma gama de opções disponíveis para as lareiras de alta qualidade e que são fáceis de instalar e usar. </p>
                    <p class="pBlueBullet jus">Lareiras a lenha aquecem rapidamente (ideal para quem trabalha e quer aquecer a sua casa apenas à noite), mas também pode ser usada para o aquecimento constante.  </p>
                    <p class="pNarBullet jus">Alguns modelos tem aquecedores de água como uma segunda alternativa a outros de sistemas de aquecimento. Existem também modelos que incluem fornos.</p>
