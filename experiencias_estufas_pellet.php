...
<?php include("inc.submenuExperiencias2.php"); ?>
                    <div class="clear"></div>
                    <p class="jus">Lareiras a pellet oferecem uma forma particularmente simples de usar madeira para aquecimento. Suas vantagens incluem a qualidade padrão de combustível, o que é garantido para queima de forma limpa deixando pouco resíduo, e facilidade de uso. Muitas lareiras a pellet são parcialmente ou totalmente automáticas. O que significa que não requerem nada manualmente. Por ter uma porta com vitrocerâmico, as lareiras a pallet são totalmente cativante. </p>
                </div>
