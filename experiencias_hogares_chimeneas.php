...
<?php include("inc.submenuExperiencias.php"); ?>
		...
		<div class="clear"></div>
          		...
          		<div class="colLeft">
                    <h1 class="tGrisN">Lareiras<br/><br/></h1>
                    <p><br/></p>
                    <img src="images/hogares-y-chimeneas_01.jpg" width="195" height="99" class="imgleft01" />
...
<?php include("inc.submenuExperiencias2.php"); ?>
                    <div class="clear"></div>
                    <h5>As lareiras podem criar um ambiente mais aconchegante e elegante do que qualquer outro tipo de aquecimento.</h5>
                    <p class="jus">Os materiais clássicos como pedra ou mármore podem melhorar o seu design, tornando-os ideais para edifícios antigos e casas modernas, estilo retrô. Ao colocar uma nova lareira, você pode desfrutar do  melhor em seu lar, graças ao seu alto desempenho, ausência de fumaça, cheiro e faíscas. Dê vida ao seu lar, instalando as novas lareiras e depois desfrute de uma visão clara do fogo, sem qualquer aborrecimento. </p>
                </div>
