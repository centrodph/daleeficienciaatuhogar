...
Cufon.replace('.myriad_pro_regular', { fontFamily: 'Myriad Pro Regular', hover: true }); 
	Cufon.replace('ul.menuHeader li a', { fontFamily: 'Myriad Pro Regular', hover: true });
	Cufon.replace('ul.menuPrincipal li a', { fontFamily: 'Myriad Pro Regular', hover: true });
	Cufon.replace('ul.subMenu li a', { fontFamily: 'Myriad Pro Regular', hover: true });
