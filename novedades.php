          ...
          <div id="novedades_l">
            <div class="boxNews">
              ...
              <div class="ndescr">
                ...
                <p>Abrange uma alta presença na grande mídia impressa no país, um site novo e renovado e intensa atividade nas
                  redes sociais - Facebook e Twitter.</p>
              </div>
            </div>
            <?php
...
div class="boxNews">
          ...
          <div id="novedades_r">
            <div id="boxLateralNews">
              <h3>Nós convidamos você a
                <br/>seguir as nossas notícias instantaneamente em sua
                <br/>rede social
              </h3>
              <div id="fb-root"></div>
              <script src="//connect.facebook.net/en_US/all.js#xfbml=1"></script>
              <fb:like-box href="//www.facebook.com/pages/Dale-vida-a-tu-hogar/140625592677754" width="320" show_faces="true" stream="true"
